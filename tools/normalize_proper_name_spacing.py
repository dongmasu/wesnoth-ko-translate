...
OVERRIDES.update(
    ...
    "WoF": "바람",
        "Xakae": "자카(Xakae)",
        "addons_of_type^MP campaigns": "멀티플레이 캠페인",
        "addons_of_type^MP eras": "멀티플레이 시대",
        "addons_of_type^MP factions": "멀티플레이 진영",
        "addons_of_type^MP map-packs": "멀티플레이 지도 모음",
        "addons_of_type^MP scenarios": "멀티플레이 시나리오",
    }
)
