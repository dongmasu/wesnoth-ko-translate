...
TRANSLATIONS = {
    ...
    "Aye. Word ha’ spread, and dwarves who had been living rough in the wilds for fear of the orcs have been coming to join us. Thanks to you, Tallin, Knalga is rising again!": "그렇소. 소문이 퍼져 오크를 피해 황야에서 힘겹게 살아가던 드워프들이 우리와 합류하러 오고 있소. 탈린, 모두 그대 덕분이오. 크날가가 다시 일어서고 있소!",
    ...
    "A Witness functions as the eyes of the dwarves’ history, a deep lore that they never share with outsiders. The presence of a Witness inspires dwarvish warriors with the knowledge that their deeds (and their deaths) will not go unrecorded. They learn a fighting style deliberately unlike that of their fellows, one designed to turn the vaunted strength of the dwarves against itself. The person of a Witness is considered sacred, and Witnesses are often used as envoys between dwarvish clans.": "증인은 드워프 역사의 눈과 같은 존재로, 외부인과 절대 공유하지 않는 깊은 전승을 지킵니다. 증인이 있으면 드워프 전사들은 자신의 행동과 죽음이 기록으로 남으리라는 사실에 고무됩니다. 증인들은 동료들과 일부러 다른 전투 방식을 배우는데, 이는 드워프들이 자랑하는 힘을 드워프 자신에게 돌리는 방식입니다. 증인은 신성한 존재로 여겨지며, 증인들은 종종 드워프 부족 사이의 사절로 활동합니다.",
