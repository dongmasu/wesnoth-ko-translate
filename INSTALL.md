...
예를 들어 현재 작업본은
`tools/build_asset.sh 1.18.x 20260925 /path/to/ko_KR.cfg`로 생성하며,
`dist/1.18.x-20260925/wesnoth-ko-translate-1.18.x-20260925.zip`에
...
`The Battle for Wesnoth.app`를 뜻합니다. `dist/<버전>-<최종수정일>/ko/LC_MESSAGES/*.mo`를
이 디렉터리에 복사합니다.
